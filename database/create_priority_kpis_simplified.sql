-- Create Priority KPIs Materialized View (Simplified for existing tables)
-- Drop if exists
DROP MATERIALIZED VIEW IF EXISTS mv_priority_kpis CASCADE;

-- Create the view using only existing tables
...
SELECT
    ...
    -- Placeholder metrics for tables that don't exist yet
