-- ============================================================================
-- Quick Fix for Materialized Views
-- ============================================================================
-- Fixes the errors in the existing materialized views:
-- 1. consultations.inquiry_id -> client_id join issue
-- 2. DATE subtraction EXTRACT issue (use simple subtraction for days)
-- ============================================================================

-- ============================================================================
-- Fix mv_sales_funnel (consultations join issue)
-- ============================================================================
...
-- ============================================================================
-- Fix mv_lead_source_performance (consultations join issue)
-- ============================================================================
...
SELECT
    ...
    -- Placeholder for CAC (will calculate when marketing_campaigns table data exists)
    0.00 as cost_per_acquisition
FROM lead_sources_metrics
ORDER BY total_revenue DESC;

CREATE INDEX idx_mv_lead_source_performance ON mv_lead_source_performance (lead_source);

-- ============================================================================
-- Fix mv_client_retention (DATE subtraction EXTRACT issue)
-- ============================================================================
...
retention_metrics AS (
    SELECT
        ...
        AVG((last_booking - first_booking))::NUMERIC as avg_client_lifetime_days
...
SELECT
    ...
    ROUND(avg_client_lifetime_days, 0) as avg_client_lifetime_days,
    CASE
...
SELECT 'Critical materialized views fixed successfully!' as status;
